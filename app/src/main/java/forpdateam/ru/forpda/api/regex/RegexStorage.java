    ...
    public static class News {
        public static class List {
            public static void saveListPattern(@NonNull String pattern) {
                App.get().getPreferences().edit().putString("news.list.pattern", pattern).apply();
            }
        ...
        public static class Details {
            ...
            public static void saveRootDetailsPattern(@NonNull String pattern) {
                App.get().getPreferences().edit().putString("news.details.root.pattern", pattern).apply();
            }
            ...
            public static void saveContentPattern(@NonNull String pattern) {
                App.get().getPreferences().edit().putString("news.details.content.pattern", pattern).apply();
            }
            ...
            public static void saveCommentsPattern(@NonNull String pattern) {
                App.get().getPreferences().edit().putString("news.details.comments.pattern", pattern).apply();
            }
            ...
            public static void saveNavigationPattern(@NonNull String pattern) {
                App.get().getPreferences().edit().putString("news.details.navigation.pattern", pattern).apply();
            }
            ...
            public static void saveMoreNewsPattern(@NonNull String pattern) {
                App.get().getPreferences().edit().putString("news.details.more.news.pattern", pattern).apply();
            }
