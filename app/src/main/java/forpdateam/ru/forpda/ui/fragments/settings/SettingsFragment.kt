...
class SettingsFragment : BaseSettingFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (authHolder.get().isAuth()) {
            ...
            findPreference("auth.action.logout").isEnabled = false
        }

        findPreference("clear_menu_sequence")
                .setOnPreferenceClickListener {
                    AlertDialog.Builder(activity!!)
        ...
        findPreference("about.application").summary = String.format(getString(R.string.version_Build), BuildConfig.VERSION_NAME)
