...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private BottomSheetBehaviorFixed<FrameLayout> behavior;
    ...
    protected void onStart() {
        super.onStart();
        if (behavior != null && behavior.getState() == BottomSheetBehaviorFixed.STATE_HIDDEN) {
            behavior.setState(BottomSheetBehaviorFixed.STATE_COLLAPSED);
        }
    }
    ...
    private BottomSheetBehaviorFixed.BottomSheetCallback bottomSheetCallback =
            new BottomSheetBehaviorFixed.BottomSheetCallback() {
                ...
                public void onStateChanged(
                        @NonNull View bottomSheet, @BottomSheetBehaviorFixed.State int newState) {
