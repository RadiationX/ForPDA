...
public class BottomSheetBehaviorFixed<V extends View> extends CoordinatorLayout.Behavior<V> implements ICustomBottomSheetBehavior<V> {
    ...
    public BottomSheetBehaviorFixed(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, @NonNull BottomSheetBehaviorFixed<?> behavior) {
            super(superState);
        ...
        /**
         * This constructor does not respect flags: {@link BottomSheetBehaviorFixed#SAVE_PEEK_HEIGHT}, {@link
         * BottomSheetBehaviorFixed#SAVE_FIT_TO_CONTENTS}, {@link BottomSheetBehaviorFixed#SAVE_HIDEABLE}, {@link
         * BottomSheetBehaviorFixed#SAVE_SKIP_COLLAPSED}. It is as if {@link BottomSheetBehaviorFixed#SAVE_NONE}
         * were set.
         *
         * @deprecated Use {@link #SavedState(Parcelable, BottomSheetBehaviorFixed)} instead.
         */
        @Deprecated
    ...
    /**
     * A utility function to get the {@link BottomSheetBehaviorFixed} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link BottomSheetBehaviorFixed}.
     * @return The {@link BottomSheetBehaviorFixed} associated with the {@code view}.
     */
    @NonNull
    @SuppressWarnings("unchecked")
    public static <V extends View> BottomSheetBehaviorFixed<V> from(@NonNull V view) {
        ...
        if (!(behavior instanceof BottomSheetBehaviorFixed)) {
            throw new IllegalArgumentException("The view is not associated with BottomSheetBehavior");
        }
        return (BottomSheetBehaviorFixed<V>) behavior;
    }
        ...
        if (state != STATE_HALF_EXPANDED) {
            expandHalfwayActionId =
                    addAccessibilityActionForState(
                            child, R.string.bottom_sheet_behavior, STATE_HALF_EXPANDED);
        }
