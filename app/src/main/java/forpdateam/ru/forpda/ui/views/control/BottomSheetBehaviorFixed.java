...
public class BottomSheetBehaviorFixed<V extends View> extends CoordinatorLayout.Behavior<V> implements ICustomBottomSheetBehavior<V> {
    ...
    public BottomSheetBehaviorFixed(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, BottomSheetBehaviorFixed behavior) {
            super(superState);
    ...
    public static <V extends View> BottomSheetBehaviorFixed<V> from(V view) {
