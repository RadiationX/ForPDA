...
sealed interface NotificationEvent {
    ...
    data class TopicMention(val id: NotificationId.TopicMention, val postId: Int) : NotificationEvent
    data class Qms(val id: NotificationId.Qms, val data: InspectorItem.Qms) : NotificationEvent
    data class SiteMention(val id: NotificationId.SiteMention, val commentId: Int) : NotificationEvent
