...
public class Constants {
    ...
    public static final String NEWS_URL_ROOT = "https://4pda.to/";
    public static final String NEWS_CATEGORY_ALL = "all_news";
    public static final String NEWS_URL_ALL = "https://4pda.to/news/";
    public static final String NEWS_CATEGORY_ARTICLES = "articles_news";
    public static final String NEWS_URL_ARTICLES = "https://4pda.to/articles/";
    public static final String NEWS_CATEGORY_REVIEWS = "reviews_news";
    public static final String NEWS_URL_REVIEWS = "https://4pda.to/reviews/";
    public static final String NEWS_CATEGORY_SOFTWARE = "software_news";
    public static final String NEWS_URL_SOFTWARE = "https://4pda.to/software/";
    public static final String NEWS_CATEGORY_GAMES = "games_news";
    public static final String NEWS_URL_GAMES = "https://4pda.to/games/";
    ...
    public static final String NEWS_URL_DEVSTORY_GAMES = "https://4pda.to/games/tag/devstory/";
    public static final String NEWS_SUBCATEGORY_WP7_GAME = "wp_game_news";
    public static final String NEWS_URL_WP7_GAME = "https://4pda.to/games/tag/games-for-windows-phone-7/";
    public static final String NEWS_SUBCATEGORY_IOS_GAME = "ios_game_news";
    public static final String NEWS_URL_IOS_GAME = "https://4pda.to/games/tag/games-for-ios/";
    public static final String NEWS_SUBCATEGORY_ANDROID_GAME = "android_game_news";
    public static final String NEWS_URL_ANDROID_GAME = "https://4pda.to/games/tag/games-for-android/";
    /*SOFTWARE*/
    public static final String NEWS_SUBCATEGORY_DEVSTORY_SOFTWARE = "ds_software_news";
    public static final String NEWS_URL_DEVSTORY_SOFTWARE = "https://4pda.to/software/tag/devstory/";
    ...
    public static final String NEWS_URL_SMARTPHONES_REVIEWS = "https://4pda.to/reviews/tag/smartphones/";
    public static final String NEWS_SUBCATEGORY_TABLETS_REVIEWS = "t_r_news";
    public static final String NEWS_URL_TABLETS_REVIEWS = "https://4pda.to/reviews/tag/tablets/";
    public static final String NEWS_SUBCATEGORY_SMART_WATCH_REVIEWS = "sw_r_news";
    public static final String NEWS_URL_SMART_WATCH_REVIEWS = "https://4pda.to/reviews/tag/smart-watches/";
    public static final String NEWS_SUBCATEGORY_ACCESSORIES_REVIEWS = "a_r_news";
    public static final String NEWS_URL_ACCESSORIES_REVIEWS = "https://4pda.to/reviews/tag/accessories/";
    public static final String NEWS_SUBCATEGORY_NOTEBOOKS_REVIEWS = "n_r_news";
    public static final String NEWS_URL_NOTEBOOKS_REVIEWS = "https://4pda.to/reviews/tag/notebooks/";
    public static final String NEWS_SUBCATEGORY_ACOUSTICS_REVIEWS = "ac_r_news";
    public static final String NEWS_URL_ACOUSTICS_REVIEWS = "https://4pda.to/reviews/tag/acoustics/";
    /*How to*/
    public static final String NEWS_SUBCATEGORY_HOW_TO_ANDROID = "h_t_a_news";
    public static final String NEWS_URL_HOW_TO_ANDROID = "https://4pda.to/tag/how-to-android/?utm_source=slider1";
    public static final String NEWS_SUBCATEGORY_HOW_TO_IOS = "h_t_i_news";
    public static final String NEWS_URL_HOW_TO_IOS = "https://4pda.to/tag/how-to-ios/?utm_source=slider1";
    public static final String NEWS_SUBCATEGORY_HOW_TO_WP = "h_t_w_news";
    public static final String NEWS_URL_HOW_TO_WP = "https://4pda.to/tag/how-to-wp/?utm_source=slider1";
    public static final String NEWS_SUBCATEGORY_HOW_TO_INTERVIEW = "interview_news";
    public static final String NEWS_URL_HOW_TO_INTERVIEW = "https://4pda.to/articles/tag/interview/";
